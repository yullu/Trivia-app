...
def create_app(test_config=None):
    ...
    def list_categories():
        listing = Category.query.order_by(Category.id).all()
        current_category = pagination_questions(request, listing)
        ...
        return jsonify({
            'success': True,
            'categories': {category.id: category.type for category in listing}
        })
